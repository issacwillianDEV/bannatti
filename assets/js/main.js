  ...
  callbacks: {
    open: function () {
      ...
      if (video.length) {
        ...
        // Se o vídeo for mais horizontal
        if (aspectRatio < 1) {
          var newWidth = window.innerWidth * 0.8; // 80% da largura da janela
          var newHeight = newWidth * aspectRatio;
        }
        // Se o vídeo for mais vertical
        else {
          var newHeight = window.innerHeight * 0.8; // 80% da altura da janela
          var newWidth = newHeight / aspectRatio;
        }

        // Definir as dimensões e centralizar o popup de acordo com o vídeo
        this.content.css({
          'width': newWidth + 'px',
          'height': newHeight + 'px',
          'margin': 'auto',
    ...
    var settings_html = `<div class="tp-theme-settings-area transition-3">
		<div class="tp-theme-wrapper">
		   <div class="tp-theme-header text-center">
			  <h4 class="tp-theme-header-title">Temas Bannatti</h4>
		   </div>
